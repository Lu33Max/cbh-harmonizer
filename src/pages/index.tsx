      ...
      <div className="flex flex-row w-full items-center justify-center ">
        ...
        <div className="flex flex-row items-center gap-10 ml-36 mt-3 justify-stretch">
          ...
          <div className={`flex flex-row items-center ${input?.name.endsWith(".xlsx") ? "text-black" : "text-gray-400"}`}>
            <label className="bg-[#9DC88D66] hover:bg-[#617e5766] py-1 text-[#164A41] px-3 rounded-l-xl font-bold whitespace-nowrap">Starting row</label>
        ...
        <div>
          ...
          <div className="ml-36 flex flex-row justify-center gap-20">
            <div className="flex flex-row ">
              <label className="bg-[#9DC88D66] hover:bg-[#617e5766] py-1 text-[#164A41] px-3 rounded-l-xl font-bold whitespace-nowrap">Search</label>
